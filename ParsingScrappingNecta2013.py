...
grades = csv.writer(open("File2013_grades.csv", "w")) # Define object "writer" named c which can later be sued to write csv
schools = csv.writer(open("File2013_schools.csv", "w")) # Define object "writer" named c which can later be sued to write csv
 
################# Get links from first page

url = r"C:/Users/Christopher/Google Drive/Python/Parsing/Parsing/Necta/www.necta.go.tz/matokeo_html_2013/psle.html"
page = open(url)
...
print(list1)
string = 'C:/Users/Christopher/Google Drive/Python/Parsing/Parsing/Necta/www.necta.go.tz/matokeo_html_2013/'
...
print(list2)
string = 'C:/Users/Christopher/Google Drive/Python/Parsing/Parsing/Necta/www.necta.go.tz/matokeo_html_2013/results/'
